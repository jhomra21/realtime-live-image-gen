...
export const AccordionItem = <T extends ValidComponent = "div">(
	...
	return (
		<AccordionPrimitive.Item class={cn("bg-gray-800 rounded-md p-2", local.class)} {...rest} />
	);
};
	...
	return (
		<AccordionPrimitive.Header class="flex" as="div">
			<AccordionPrimitive.Trigger
				class={cn(
					"flex flex-1 items-center justify-between my-2 text-sm font-medium transition-shadow hover:underline focus-visible:outline-none focus-visible:ring-[1.5px] focus-visible:ring-ring [&[data-expanded]>svg]:rotate-180",
					local.class,
				)}
				{...rest}
			>
